<?php
  ...
  // Menghitung jumlah pengguna dari tabel tb_pengguna
  $sql = $koneksi->query("SELECT COUNT(id_pengguna) as pengguna from tb_pengguna");
    while ($data= $sql->fetch_assoc()) {
      $jml=$data['pengguna']; // Menyimpan jumlah pengguna ke dalam variabel $jml
  }
?>
...
<div class="row">
	...
	<div class="col-lg-4 col-6">
		...
		<div class="small-box bg-primary">
			...
			<a href="?page=MyApp/data_pengurus" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>

<?php
    //Mulai Sesion
    session_start();
	// Periksa apakah pengguna belum login, lalu redirect ke halaman login
    if (isset($_SESSION["ses_username"])==""){
	header("location: login");
    
    }else{
	// Jika pengguna sudah login, ambil data sesi
...
<head>
	...
	<link rel="icon" href="../kas_masjid/dist/img/Mosque.jpg">
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="#" class="brand-link">
				<img src="../kas_masjid/dist/img/Mosque.jpg" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
        ...
        ?>
						<li class="nav-item">
							<a href="index" class="nav-link">
								...
								<p>
									Dashboard
									<span class="badge badge-primary right">4 Info</span>
								</p>
							</a>
						</li>

						<li class="nav-item">
							<a href="?page=MyApp/data_pengurus" class="nav-link">
          ...
          ?>
						<li class="nav-item">
							<a href="index" class="nav-link">
								...
								<p>
									Dashboard
									<span class="badge badge-warning right">3 Info</span>
								</p>
							</a>
						</li>

						<li class="nav-item">
							<a href="?page=MyApp/viewonly" class="nav-link">
								<i class="nav-icon far fa-user"></i>
								<p>
									Pengurus
								</p>

<?php
    // Jika parameter "kode" diterima melalui URL
    if(isset($_GET['kode'])){ 
...
<?php
    ...
    if (isset ($_POST['Ubah'])){
    // Query untuk mengubah data pengguna berdasarkan id_pengguna
    ...
    if ($query_ubah) {
      // Jika proses update berhasil, tampilkan pesan sukses menggunakan SweetAlert dan redirect ke halaman data_pengguna
        echo "<script>
      ...
      // Jika proses update gagal, tampilkan pesan error menggunakan SweetAlert dan redirect ke halaman data_pengguna
      echo "<script>

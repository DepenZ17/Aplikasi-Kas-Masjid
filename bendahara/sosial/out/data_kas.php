<div class="alert alert-danger alert-dismissible">
	...
	// Mengambil total pengeluaran dari tabel kas_sosial dengan jenis 'Keluar'
	...
	<div class="card-body">
		<div class="table-responsive">
			...
			<table id="example1" class="table table-bordered table-striped">
			  ...
			  // Mengambil data kas sosial dengan jenis 'Keluar' dan diurutkan berdasarkan tanggal secara descending

...
if (isset($_POST['Simpan'])) {
    ...
    $sql_simpan = "INSERT INTO kas_sosial(tgl_ks, uraian_ks, masuk, keluar, jenis, id_pengguna) VALUES (
        '" . $_POST['tgl_ks'] . "',
        '" . $_POST['uraian_ks'] . "',
        '" . $masuk_hasil . "',
        '0',
        'Masuk',
        '$data_id_pengguna'  -- Menyimpan ID pengguna sebagai pencatat
    )";
...
<script type="text/javascript">
    ...
    masuk.addEventListener('keyup', function (e) {
        ...
        // Gunakan fungsi formatmasuk() untuk mengubah angka yang diketik menjadi format angka
